...
class ChromeCastComponent extends Component {
    ...
    chromecastCastMedia() {
        ...
        Chromecast.castMedia('http://vb.h265.se/v/ebS0cV09QbLsn9dmBo-r0A.html', 'Video Test', 'http://camendesign.com/code/video_for_everybody/poster.jpg', 0);
    };
    ...
    renderChromecastList(chromecast) {
        return (
            <TouchableOpacity style={[styles.button, styles.chromecastButton]} onPress={() => this.connectToChromecast(chromecast.id)} key={chromecast.id}>
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.chromecastAround}>{this.state.chromecastAround
                        ? 'YES'
                        : 'NO'}</Text>
...
export default ChromeCastComponent;
